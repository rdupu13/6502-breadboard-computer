...
; Zero page ($0000 - $00FF):
PTR_1 = $00						; Pointer 1 (w)
PTR_2 = $02						; Pointer 2 (w)

; Stack: $0100 - $03FF

MESSAGE = $0400					; LCD Print Message (str 256 b)

NUMBER = $0500					; Unsigned integer number to be converted to ASCII (w)
MOD10 = $0502					; Number mod 10 (w)
VALUE = $0504					; Current division value (w)
; Empty: $0506 - $050F
...
DATE_YEAR = $0515				; System date year (w)
